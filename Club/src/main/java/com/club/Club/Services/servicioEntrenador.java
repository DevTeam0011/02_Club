...
public class servicioEntrenador {
   ...
   public void CrearEntrenador(EntrenadorDTO EDTO) throws Exception {
        ...
        metodosUtiles.validateFieldsAreNotEmptyOrNull(
                new String[] { "nombre", "descripcion", "horario", "costo" }, EDTO.getNombre(), EDTO.getDescripcion(),
                EDTO.getHorario(), EDTO.getCosto());
        ...
        newEntre.setHorarioDisponibilidad(EDTO.getHorarioDisponabilidad());
...
public void modificarEntrenador(EntrenadorDTO EDTO) throws Exception {
    ...
    if (entrenador.isPresent()) {
        ...
        respuesta.setHorarioDisponibilidad(EDTO.getHorarioDisponabilidad());
